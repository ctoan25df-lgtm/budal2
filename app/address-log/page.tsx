...
const sources = [
  ...
  {
    label: "Telegram @bamdalincs",
    url: SITE.telegramUrl,
    observed: "밤의달인 CS 공개 연락 채널",
    status: "문의·안내용 · 주소 단독 확정 근거로 쓰지 않음",
  },
  {
...
const FAQ = [
  ...
  },
  {
    ...
    a: "복수 표기 자체가 관찰 결과입니다. 그중 하나를 임의로 고르기보다 생활권 허브·사이트 안내와 겹치는 호스트가 있는지를 먼저 보고, 겹치지 않으면 입력을 보류하세요.",
  },
  {
      ...
      <div className="wrap article-wrap">
        ...
        <section className="article-section">
          ...
          <div className="two-column">
            <div>
              <h3>생활권 허브 (Linktree 역할)</h3>
              <p>
                norangbudal.com은 부산·경남 생활권·이동축을 모아 두는 밤달 허브입니다.
                “바로가기” 문구와 실제 호스트가 항상 1:1로 대응하지 않을 수 있으므로,
                클릭 전 표시 URL과 클릭 후 주소창을 모두 기록하는 편이 좋습니다. 이
                허브는 부달 공식 주소를 대신하지 않으며, 지리·안내 출발점으로만
                씁니다.
              </p>
              <h3>Telegram CS (@bamdalincs)</h3>
              <p>
                밤의달인 CS Telegram은 문의·안내 전달에 쓰입니다. 같은 채널
                안에서도 안내 문구와 실제 접속 호스트를 구분해 읽고, 확인 시각과
                메시지 요지를 따로 남겨 두는 것이 중요합니다. CS 채널만으로 부달
                공식 호스트를 단정하지 않습니다.
              </p>
            </div>
            <div>
              ...
              <p>
                ...
                않습니다. 참고용으로 열더라도, 생활권 허브·Telegram CS·서비스
                내부 안내와 같은 호스트를 말하는지 교차 확인하기 전까지는
                로그인이나 결제로 넘어가지 않는 편이 낫습니다.
              </p>
        ...
        <section className="article-section">
          ...
          <ol className="steps">
            {[
              ...
              "생활권 허브·Telegram CS·사이트 안 안내가 같은 호스트를 가리키는지 봅니다. 서로 다르면 그 차이를 해소하기 전에 하나를 고르지 않습니다.",
